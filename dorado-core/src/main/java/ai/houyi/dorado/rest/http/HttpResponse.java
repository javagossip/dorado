...
public interface HttpResponse {
	 ...
	 *
	 * This definition is being retained for backwards compatibility. SC_FOUND is
	 ...
	 * under a different URI. The temporary URI <em>SHOULD</em> be given by the
	 ...
	 * <code><em>Request-Line</em></code> is not allowed for the resource identified
	 * by the <code><em>Request-URI</em></code>.
	 */
	...
	/**
	 * Status code (407) indicating that the client <em>MUST</em> first authenticate
	 ...
	 * server and no forwarding address is known. This condition <em>SHOULD</em> be
	...
	void writeStringUtf8(String invokeResult);

	void write(InputStream invokeResult);
}
