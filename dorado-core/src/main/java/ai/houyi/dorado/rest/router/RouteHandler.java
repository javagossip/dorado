...
public class RouteHandler {
    ...
    private RouteHandler(MethodDescriptor methodDescriptor) {
        this.methodDescriptor = methodDescriptor;
    }

    public static RouteHandler create(Method method) {
        Assert.notNull(method, "method must not be null");
        return new RouteHandler(MethodDescriptor.create(method.getDeclaringClass(), method));
    }

    public void handle(Route route, HttpRequest request, HttpResponse response) {
        ...
        Object[] args = resolveParameters(request, response, route);
    ...
    private Object[] resolveParameters(HttpRequest request, HttpResponse response, Route route) {
