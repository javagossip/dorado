...
public class TestExceptionHandler implements ExceptionHandler {
	...
	@Override
	public Object handleException(Exception exception, HttpResponse response) {
		return TestResp.builder().withCode(1).withMsg(ExceptionUtils.toString(exception)).build();
	}
}
